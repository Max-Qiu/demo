...
import com.maxqiu.socket2.common.constants.UDPConstants;
import com.maxqiu.socket2.common.utils.ByteUtils;
...
public class UDPSearcher {
    ...
    private static Listener listen(CountDownLatch receiveLatch) throws InterruptedException {
        System.out.println("开启UDP搜索回送消息监听");
    ...
    private static void sendBroadcast() throws IOException {
        ...
        // 完成
        System.out.println("UDP广播消息发送完毕");
    }
        ...
        public void run() {
            ...
            try {
                ...
                while (!done) {
                    ...
                    System.out.println("UDP回送消息监听线程收到数据！来自IP:" + ip + "\tport:" + port + "\tdataValid:" + isValid);
            ...
            System.out.println("UDP搜索回送消息监听已关闭");
        }
