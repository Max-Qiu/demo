...
public class BatchInsertTest {
    ...
    /**
     * 批量插入的方式三：<br>
     * 1.addBatch()、executeBatch()、clearBatch()<br>
     * 2.mysql服务器默认是关闭批处理的，需要通过一个参数，让mysql开启批处理的支持。 ?rewriteBatchedStatements=true 写在配置文件的url后面<br>
